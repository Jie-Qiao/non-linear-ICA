...
showtimedata(source, xlabel="Time", ylabel="Channel", fontsize=14, linewidth=1.5,
                 intervalstd=10, figsize=None)
showtimedata(sensor, xlabel="Time", ylabel="Channel", fontsize=14, linewidth=1.5,
                 intervalstd=10, figsize=None)
...
#
print(feateval.shape,xseval.shape)
...
print("    Mean correlation     : {0:7.4f}".format(meanabscorr))
