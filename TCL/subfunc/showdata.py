...
# showmat
# =============================================================
def showmat(X, filename, xlabel=None, ylabel=None, fontsize=14, crange=None, figsize=None):
...
# showtimedata
# =============================================================
def showtimedata(X, filename,xlabel="Time", ylabel="Channel", fontsize=14, linewidth=1.5,
